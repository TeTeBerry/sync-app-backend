      ...
      options: [
        {
          ...
          label: '激光射线+爆闪（刺激）',
          weights: w({ rager: 3 }),
          mediaAssetKey: PERSONALITY_TEST_MEDIA.VJ_LASER_FLASH,
          mediaPosterAssetKey: PERSONALITY_TEST_MEDIA.VJ_LASER_POSTER,
        },
        {
          id: 'vj-style-grid-b',
          label: '粒子流动+渐变（沉浸）',
          weights: w({ zen_raver: 2, vibe_curator: 1 }),
          mediaAssetKey: PERSONALITY_TEST_MEDIA.VJ_PARTICLE_FLOW,
          mediaPosterAssetKey: PERSONALITY_TEST_MEDIA.VJ_PARTICLE_POSTER,
        },
        {
          id: 'vj-style-grid-c',
          label: '几何矩阵+节奏同步（理性）',
          weights: w({ connoisseur: 3 }),
          mediaAssetKey: PERSONALITY_TEST_MEDIA.VJ_GEOMETRY_MATRIX,
          mediaPosterAssetKey: PERSONALITY_TEST_MEDIA.VJ_GEOMETRY_POSTER,
        },
        {
          id: 'vj-style-grid-d',
          label: '霓虹文字+复古（怀旧）',
          weights: w({ vibe_curator: 2, documentarian: 1 }),
          mediaAssetKey: PERSONALITY_TEST_MEDIA.VJ_NEON_RETRO,
          mediaPosterAssetKey: PERSONALITY_TEST_MEDIA.VJ_NEON_POSTER,
        },
      ],
    },
    {
