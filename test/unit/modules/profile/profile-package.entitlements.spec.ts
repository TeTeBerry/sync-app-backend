...
import { FREE_MONTHLY_CONTACT_UNLOCK_LIMIT } from '@src/modules/profile/domain/free-tier.config';
...
describe('per-activity entitlement quotas', () => {
  ...
  it('activity without purchase gets free-only merged quotas (3 contact)', () => {
